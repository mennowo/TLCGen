...
#pragma warning disable 0649
        ...
        private CCOLGeneratorCodeStringSettingModel _prmnivrtndim;
...
#pragma warning restore 0649
        ...
        public override void CollectCCOLElements(ControllerModel c)
        {
            ...
            foreach (var rt in c.Signalen.Rateltikkers)
            {
                ...
                {
                    _myElements.Add(CCOLGeneratorSettingsProvider.Default.CreateElement($"{_prmnivrtndim}{rt.FaseCyclus}", rt.DimmingNiveauPeriodeNietDimmen, CCOLElementTimeTypeEnum.None, _prmnivrtndim, rt.FaseCyclus));
                    _myElements.Add(CCOLGeneratorSettingsProvider.Default.CreateElement($"{_prmnivrtdim}{rt.FaseCyclus}", rt.DimmingNiveauPeriodeDimmen, CCOLElementTimeTypeEnum.None, _prmnivrtndim, rt.FaseCyclus));
                }
                        ...
                        foreach (var rt in c.Signalen.Rateltikkers)
                        {
                            switch (rt.Type)
                            {
                                ...
                                case RateltikkerTypeEnum.HoeflakeBewaakt:
                                    ...
                                    {
                                        sb.AppendLine($"{ts}GUS[{_uspf}{_usrtdim}{rt.FaseCyclus}] = Rateltikkers_HoeflakeDimming({_fcpf}{rt.FaseCyclus}, {_hpf}{_hperiod}{_prmperrtdim}, {_prmpf}{_prmnivrtndim}{rt.FaseCyclus}, {_prmpf}{_prmnivrtdim}{rt.FaseCyclus});");
                                    }
                                    else
                                    {
