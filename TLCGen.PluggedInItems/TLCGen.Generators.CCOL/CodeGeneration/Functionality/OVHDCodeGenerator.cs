        ...
        public override IEnumerable<Tuple<string, string, string>> GetFunctionLocalVariables(ControllerModel c, CCOLCodeTypeEnum type)
        {
            switch (type)
            {
                ...
                case CCOLCodeTypeEnum.OvCPostAfhandelingOV:
                    ...
                    {
                        result2.Add(new Tuple<string, string, string>("boolv", "isHD", "FALSE"));
                        if (c.Fasen.Any(x => x.WachttijdVoorspeller)) result2.Add(new Tuple<string, string, string>("boolv", "isWTV", "FALSE"));
