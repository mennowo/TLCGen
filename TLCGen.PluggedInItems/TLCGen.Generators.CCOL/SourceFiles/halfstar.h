...
void rhdhv_getrapte_voetganger_pl(count fc1,count fc2, bool a_bui_fc1, bool a_bui_fc2, count tkopfc1fc2, count tkopfc2fc1, count voorstartfc1fc2, count voorstartfc2fc1);
